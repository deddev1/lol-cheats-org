...
const REPLACEMENTS = [
	...
	['Warzone CheatsSite', 'FortniteCheatsSite'],
	['Ricochet anti-cheat', 'Vanguard (EAC)'],
	['Ricochet maintenance', 'EAC maintenance'],
	['Ricochet bypass', 'EAC bypass'],
	['Ricochet Bypass', 'EAC Bypass'],
	['Ricochet', 'Vanguard (EAC)'],
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'survival island, Zero Build, and ranked servers'],
	['Verdansk, Urzikstan and Rebirth Island', 'survival island, Zero Build and ranked servers'],
	...
	['low-health targets', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'survival island'],
	['al-mazrah', 'moba-island'],
