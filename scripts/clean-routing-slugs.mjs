...
// Fix vanguard-bypass slugs that got double-replaced
content = content.replace(/vanguard-bypass-bypass/g, 'vanguard-bypass');
content = content.replace(/vanguard-bypass-trucos-lol/g, 'vanguard-bypass-trucos-lol');
