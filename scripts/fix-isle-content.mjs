...
const REPLACEMENTS = [
	...
	['LoL radar', 'LoL radar'],
	['LoL Cheats vs Typical Budget EFT', 'LoL Cheats vs Typical Budget LoL'],
	['Budget EFT Cheat Shops', 'Budget LoL Cheat Shops'],
	['Budget EFT', 'Budget LoL'],
	['against budget EFT', 'against budget lol'],
	['EFT Cheat Shops', 'LoL Cheat Shops'],
	...
	['heroImage', 'heroImage'],
	['Undetected EFT cheats for PC.', 'Undetected LoL Cheats for PC.'],
