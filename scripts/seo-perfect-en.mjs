...
const replacements = [
	...
	['boss and extract awareness cues', 'apex and objective awareness cues'],
	['boss threat cues', 'baron threat cues'],
	['bosses, and wards', 'baron buffs, and wards'],
	['track baron buffs and wards', 'track baron buffs and wards'],
	['ARs, SMGs, and skillshots', 'assassins, mages, and marksmen'],
	['skillshot DMR fights and dorms clears', 'skillshot picks and teamfight clears'],
	['Save separate Aimbot profiles for ARs, SMGs, and skillshots', 'Save separate Aimbot profiles for assassins, mages, and marksmen'],
	...
	['boss threat cues, wards and ward markers', 'baron threat cues, ward and objective markers'],
	['wards, wards, and bosses', 'wards, objectives, and baron buffs'],
	...
	['enemy teams, bosses, and low-health targets', 'enemy teams, baron buffs, and low-health targets'],
	[
	...
	['track vehicles and chests', 'track baron buffs and wards'],
