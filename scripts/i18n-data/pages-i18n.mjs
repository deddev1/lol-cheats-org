...
const PAGE_META_HOME = {
	...
	pt: { title: 'LoL Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats League of Legends indetectáveis para League of Legends no PC. ESP wallhack, radar cheat e Aimbot com manutenção Vanguard. Entrega digital instantánea.', h1: 'LoL Cheats — ESP, Wallhack e Aimbot indetectáveis', intro: 'Pacote undetected para League of Legends no Windows PC: ESP wallhack, radar e Aimbot com manutenção Vanguard após cada patch.', imageAlt: 'LoL ESP player tags cheat', gallery: 'GaleriLoL Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher LoL Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler eteamrões inimigos em BR e ARAM game.', topicB: 'Uma licença em vez de ferramentas separadas.' },
