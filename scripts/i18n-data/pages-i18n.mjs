...
const PAGE_META_HOME = {
	es: { title: 'LoL Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos League of Legends indetectables parLeague of Legends en PC. ESP wallhack, radar cheat y Aimbot con mantenimiento Vanguard. Entrega digital instantánea.', h1: 'LoL Cheats — ESP, Wallhack y Aimbot indetectables', intro: 'Paquete undetected parLeague of Legends en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento Vanguard tras cada parche.', imageAlt: 'LoL ESP — etiquetas de jugador cheat', gallery: 'GaleríLoL Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen LoL Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer escuadrones enemigos en BR y ARAM game.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	...
	pt: { title: 'LoL Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats League of Legends indetectáveis parLeague of Legends no PC. ESP wallhack, radar cheat e Aimbot com manutenção Vanguard. Entrega digital instantánea.', h1: 'LoL Cheats — ESP, Wallhack e Aimbot indetectáveis', intro: 'Pacote undetected parLeague of Legends no Windows PC: ESP wallhack, radar e Aimbot com manutenção Vanguard após cada patch.', imageAlt: 'LoL ESP player tags cheat', gallery: 'GaleriLoL Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher LoL Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler eteamrões inimigos em BR e ARAM game.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'LoL Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat League of Legends indetectable per League of Legends su PC. ESP wallhack, radar cheat e Aimbot con manutenzione Vanguard. Consegna digitale istantanea.', h1: 'LoL Cheats — ESP, Wallhack e Aimbot indetectable', intro: 'Pacchetto undetected per League of Legends su PC Windows: ESP wallhack, radar e Aimbot con manutenzione Vanguard dopo ogni patch.', imageAlt: 'LoL ESP player tags cheat', gallery: 'GalleriLoL Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere LoL Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere teamre nemiche in BR e ARAM game.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'LoL Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected lol cheats voor League of Legends op PC. ESP wallhack, radar cheat en Aimbot met Vanguard-onderhoud. Directe digitale levering.', h1: 'LoL Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC pakket voor League of Legends: ESP wallhack, radar en Aimbot met Vanguard-onderhoud na elke patch.', imageAlt: 'LoL ESP player tags cheat', gallery: 'LoL Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom LoL Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke teams te lezen in BR en ARAM game.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'LoL Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'Undetected cheaty League of Legends dlLeague of Legends na PC. ESP wallhack, radar cheat i Aimbot z konserwacją Vanguard. Natychmiastowa dostawa cyfrowa.', h1: 'LoL Cheats — Undetected ESP, Wallhack i Aimbot', intro: 'Pakiet undetected dlLeague of Legends na Windows PC: ESP wallhack, radar i Aimbot z konserwacją Vanguard po każdym patchu.', imageAlt: 'LoL ESP player tags cheat', gallery: 'GaleriLoL Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego LoL Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich teamów w BR i ARAM game.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	...
	tr: { title: 'LoL Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'League of Legends için undetected hileler. ESP wallhack, radar cheat ve Aimbot — Vanguard bakımı. Anında dijital teslimat.', h1: 'LoL Cheats — Undetected ESP, Wallhack ve Aimbot', intro: 'League of Legends Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — Vanguard bakımı dahil.', imageAlt: 'LoL ESP player tags cheat', gallery: 'LoL Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden LoL Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'BR ve ARAM game\'da düşman team okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'LoL Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش League of Legends undetected لـ League of Legends على PC. ESP wallhack ورadar hack وAimbot مع صيانة Vanguard. تسليم رقمي فوري.', h1: 'LoL Cheats — ESP وWallhack وAimbot غير مكتشف', intro: 'حزمة undetected لـ League of Legends على Windows PC: ESP wallhack ورadar وAimbot مع صيانة Vanguard.', imageAlt: 'LoL ESP player tags cheat', gallery: 'معرض LoL Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا LoL Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وARAM game.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'LoL Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'League of Legends向けundetectedチート。ESP wallhack、radar cheat、Aimbot、Vanguardメンテナンス。即時デジタル配信。', h1: 'LoL Cheats — Undetected ESP・Wallhack・Aimbot', intro: 'League of Legends Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、Vanguardメンテナンス付き。', imageAlt: 'lol cheats hero ESP aimbot wallhack', gallery: 'LoL Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にLoL Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとARAM gameで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'LoL Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'League of Legends undetected 치트. ESP wallhack, radar cheat, Aimbot, Vanguard 유지보수. 즉시 디지털 배송.', h1: 'LoL Cheats — Undetected ESP, Wallhack, Aimbot', intro: 'League of Legends Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, Vanguard 유지보수 포함.', imageAlt: 'lol cheats hero ESP aimbot wallhack', gallery: 'LoL Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 LoL Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 ARAM game에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'LoL Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'League of Legends undetected作弊。ESP wallhack、radar cheat、Aimbot、Vanguard维护。即时数字交付。', h1: 'LoL Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'League of Legends Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含Vanguard维护。', imageAlt: 'lol cheats hero ESP aimbot wallhack', gallery: 'LoL Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择LoL Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和ARAM game中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	...
	id: { title: 'LoL Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat League of Legends undetected untuk League of Legends di PC. ESP wallhack, radar cheat, Aimbot, pemeliharaan Vanguard. Pengiriman digital instan.', h1: 'LoL Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Paket undetected League of Legends di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan Vanguard.', imageAlt: 'LoL ESP player tags cheat', gallery: 'Galeri LoL Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'MengapLoL Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca team musuh di BR dan ARAM game.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'LoL Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Cheat League of Legends undetected สำหรับ League of Legends บน PC. ESP wallhack, radar cheat, Aimbot, Vanguard maintenance. จัดส่งดิจิทัลทันที.', h1: 'LoL Cheats — Undetected ESP, Wallhack และ Aimbot', intro: 'แพ็ก undetected สำหรับ League of Legends บน Windows PC: ESP wallhack, radar, Aimbot พร้อม Vanguard maintenance', imageAlt: 'LoL ESP player tags cheat', gallery: 'แกลเลอรี LoL Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก LoL Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน team ศัตรูใน BR และ ARAM game', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'LoL Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat League of Legends undetected cho League of Legends trên PC. ESP wallhack, radar cheat, Aimbot, bảo trì Vanguard. Giao hàng kỹ thuật số tức thì.', h1: 'LoL Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Gói undetected League of Legends trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì Vanguard.', imageAlt: 'LoL ESP player tags cheat', gallery: 'Thư viện LoL Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn LoL Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc team địch trong BR và ARAM game.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
