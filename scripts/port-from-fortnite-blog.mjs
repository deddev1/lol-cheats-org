#!/usr/bin/env node
/**
 * Ports the 8 posts from ../lol-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'lol-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'moba-meta': 'match Meta',
	'zero-build-strategies': 'ARAM game',
	'skin-leaks-cosmetics': 'Skin Previews & Cosmetics',
	'weapon-tier-lists': 'Champion Tier Lists',
...
const IMAGE_KEYS = {
	'zero-build-meta-broken-aggressive-strategies': 'rankedCombat',
	'secret-loot-routes-full-gold': 'summonersRiftMap',
	'hammer-ar-s-tier-data-analysis': 'aimbotCombat',
	'chapter-7-season-3-skin-leaks-vbucks': 'headerArt',
	'fncs-meta-watch-community-event-drops': 'teamfight',
	'bugha-settings-pro-setup': 'cheatsPackage',
	'creative-warmup-maps-pros-use': 'champEsp',
...
const file = `/* Auto-generated by scripts/port-from-lol-blog.mjs — do not edit by hand. */
