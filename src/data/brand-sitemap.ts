...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/lol-cheats-esp.webp',
		title: 'lol cheats esp',
		caption: 'lol cheats esp wallhack',
	},
	{
		src: '/images/lol-cheats-wallhack.webp',
		title: 'lol cheats wallhack',
		caption: 'lol cheats wallhack esp',
	},
	{
		src: '/images/lol-cheats-aimbot.webp',
		title: 'lol cheats aimbot',
		caption: 'lol cheats aimbot soft aim',
	},
	{
		src: '/images/lol-cheats-aimbot-view.webp',
		title: 'lol cheats aimbot',
		caption: 'lol cheats aimbot view',
	},
	{
		src: '/images/lol-cheats-radar.webp',
		title: 'lol cheats radar',
		caption: 'lol cheats radar hack',
	},
	{
		src: '/images/lol-cheats-match.webp',
		title: 'lol cheats',
		caption: 'lol cheats in match',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in League of Legends', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'lol-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'lol-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	vanguard: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a Vanguard update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for League of Legends on PC' },
	cheats: { title: '{primaryKeyword}', caption: '{primaryKeyword} ESP, aimbot, and radar teamage' },
	...
	'best-cheats': { title: 'Best {primaryKeyword}', caption: 'Why champions pick {primaryKeyword}' },
	'aimbot-cheat': { title: '{primaryKeyword} aimbot', caption: 'Aimbot tools in {primaryKeyword}' },
	'esp-cheat': { title: '{primaryKeyword} ESP', caption: 'ESP tools in {primaryKeyword}' },
