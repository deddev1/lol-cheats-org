...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		lead: 'League of Legends Hacks helps you spot enemy champions, minions, wards, and objectives with ESP, aimbot, and radar in one license.',
		highlights: [
	...
	es: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks está pensado para el loop BR de League of Legends: leer el mapa, rastrear escuadrones enemigos, wardsear y sobrevivir al extract.',
		highlights: [
		...
		updatesLabel: 'Actualizaciones League of Legends Hacks',
		updatesShort: 'Updates',
	},
	fr: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks suit la boucle BR de League of Legends : lire la carte, suivre les escouades, wards et survivre au extract.',
		highlights: [
		...
		updatesLabel: 'Mises à jour League of Legends Hacks',
		updatesShort: 'Updates',
	},
	de: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks passt zur Raid-Schleife von League of Legends: Karte lesen, Gegner-Trupps tracken, jagen und Nester überleben.',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks Updates',
		updatesShort: 'Updates',
	},
	pt: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks segue o loop BR do League of Legends: ler o mapa, rastrear eteamrões, wardsar e sobreviver ao extract.',
		highlights: [
		...
		updatesLabel: 'Atualizações League of Legends Hacks',
		updatesShort: 'Updates',
	},
	it: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks è pensato per il loop BR di League of Legends: leggere la mappa, tracciare teamre nemiche, wards e sopravvivere al extract.',
		highlights: [
		...
		updatesLabel: 'Aggiornamenti League of Legends Hacks',
		updatesShort: 'Updates',
	},
	nl: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks volgt de match-loop vLeague of Legends: kaart lezen, vijandelijke teams volgen, jagen en objective zones overleven.',
		highlights: [
	...
	pl: {
		...
		lead: 'League of Legends Hacks pasuje do pętli BR League of Legends: czytaj mapę, śledź wrogie drużyny, wardsuj i przeżyj extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizacje League of Legends Hacks',
		updatesShort: 'Updates',
	},
	ru: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks создан для рейд-циклу League of Legends: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
		...
		updatesLabel: 'Обновления League of Legends Hacks',
		updatesShort: 'Updates',
	},
	tr: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks, League of Legends BR döngüsü için: haritayı oku, düşman takımları izle, wards al ve extract\'da hayatta kal.',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks güncellemeleri',
		updatesShort: 'Updates',
	},
	ar: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks مبني لحلقة BR في League of Legends: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في extract.',
		highlights: [
		...
		updatesLabel: 'تحديثات League of Legends Hacks',
		updatesShort: 'Updates',
	},
	ja: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends HacksはLeague of LegendsのBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてextractを生き延びる。',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks更新',
		updatesShort: 'Updates',
	},
	ko: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks는 League of Legends survival loop용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks 업데이트',
		updatesShort: 'Updates',
	},
	zh: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks 为 League of Legends survival loop设计：读图、追踪敌方小队、搜刮并在 nest survival。',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks 更新',
		updatesShort: 'Updates',
	},
	hi: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks League of Legends survival loop के लिए: map पढ़ें, enemy teams track करें, wards करें और nest survival करें।',
		highlights: [
	...
	id: {
		...
		lead: 'League of Legends Hacks untuk loop BR League of Legends: baca peta, lacak team musuh, wards, dan selamat di extract.',
		highlights: [
		...
		updatesLabel: 'Update League of Legends Hacks',
		updatesShort: 'Updates',
	},
	th: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks สำหรับลูป BR ของ League of Legends: อ่านแผนที่ ติดตามทีมศัตรู เก็บ wards และรอด extract',
		highlights: [
		...
		updatesLabel: 'อัปเดต League of Legends Hacks',
		updatesShort: 'Updates',
	},
	vi: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks cho vòng BR League of Legends: đọc bản đồ, theo dõi team địch, wards và sống sót extract.',
		highlights: [
		...
		updatesLabel: 'Cập nhật League of Legends Hacks',
		updatesShort: 'Updates',
	},
	uk: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks для рейд-циклу League of Legends: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
		...
		updatesLabel: 'Оновлення League of Legends Hacks',
		updatesShort: 'Updates',
	},
	cs: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks pro BR smyčku League of Legends: číst mapu, sledovat nepřátelské teamy, wards a přežít extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizace League of Legends Hacks',
		updatesShort: 'Updates',
	},
	ro: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks pentru bucla BR League of Legends: citește harta, urmărește team-uri inamice, wards și supraviețuiește extract.',
		highlights: [
		...
		updatesLabel: 'Actualizări League of Legends Hacks',
		updatesShort: 'Updates',
	},
	sv: {
		eyebrow: 'League of Legends Hacks',
		...
		lead: 'League of Legends Hacks för League of Legends:s match-loop: läs kartan, spåra fiendeteams, wardsa och överlev extract.',
		highlights: [
		...
		updatesLabel: 'League of Legends Hacks uppdateringar',
		updatesShort: 'Updates',
	},
};
