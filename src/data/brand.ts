...
export const brand = {
	...
	sitemap: {
		...
		images: [
			{
				src: '/images/lol-screenshot-01.webp',
				title: 'League of Legends gameplay screenshot 1',
				caption: 'League of Legends Summoner\'s Rift teamfight on Windows PC',
			},
			{
				src: '/images/lol-screenshot-02.webp',
				title: 'League of Legends gameplay screenshot 2',
				caption: 'Ranked match action in League of Legends',
			},
			{
				src: '/images/lol-screenshot-03.webp',
				title: 'League of Legends gameplay screenshot 3',
				caption: 'Lane skirmishes and champion trades in League of Legends',
			},
			{
				src: '/images/lol-screenshot-04.webp',
				title: 'League of Legends gameplay screenshot 4',
				caption: 'Jungle ganks and map rotations in League of Legends',
			},
			{
				src: '/images/lol-screenshot-05.webp',
				title: 'League of Legends gameplay screenshot 5',
				caption: 'Team fights and objective control in League of Legends',
			},
			{
