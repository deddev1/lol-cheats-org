...
const icons: Record<string, string> = {
	...
	faq: 'M12 3c-4.4 0-8 3.1-8 7s3.6 7 8 7h1v2.5l3.5-3.5H20c4.4 0 8-3.1 8-7s-3.6-7-8-7z',
	blog: 'M6 3.5h12a2 2 0 012 2v13a2 2 0 01-2 2H6a2 2 0 01-2-2v-13a2 2 0 012-2zm3 8h6M9 12h6',
};
